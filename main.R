...
plot(out$TIME, out$RHO_S1, lty = 'blank', type = 'b', xlab = 'Time, s', ylab = expression(bold(rho ~ " 7 x 21 mm")), col = 'red')
plot(out$TIME, out$RHO_S2, lty = 'blank', type = 'b', xlab = 'Time, s', ylab = expression(bold(rho ~ " 35 x 21 mm")), col = 'orange')
...
plot(out$TIME, out$RHO_S1, lty = 'solid', type = 'l', xlab = 'Time, s', ylab = expression(bold(rho ~ " 7 x 21 mm")), col = 'red',
...
plot(out$TIME, out$RHO_S1_DIFF, lty = 'solid', type = 'l', xlab = 'Time, s', ylab = expression(bold(frac(partialdiff ~ rho, partialdiff ~ phi) ~ " 7 x 21 mm")), col = 'orange',
...
plot(out$TIME, out$RHO_S2, lty = 'solid', type = 'l', xlab = 'Time, s', ylab = expression(bold(rho ~ " 35 x 21 mm")), col = 'red',
...
plot(out$TIME, out$RHO_S2_DIFF, lty = 'solid', type = 'l', xlab = 'Time, s', ylab = expression(bold(frac(partialdiff ~ rho, partialdiff ~ phi) ~ " 35 x 21 mm")), col = 'orange',
